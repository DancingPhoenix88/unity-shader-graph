...
namespace B83.UVViewerB83
{
    ...
    public class UVViewerB83 : EditorWindow
    {
        ...
        [MenuItem("Window/UVViewerB83")]
        static void Init()
        {
            GetWindow<UVViewerB83>();
            //Instance.Focus();
        }
        ...
        void OnEnable()
        {
            titleContent = new GUIContent("UV Viewer B83");
